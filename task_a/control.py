...
from task_a.config import SIZE_MAP
...
POS_THRESHOLD = 0.005        # metres — convergence threshold
MAX_STEPS_PER_PHASE = 500    # simulation steps before declaring a phase timed-out
GRIPPER_WAIT_STEPS = 50      # steps to hold the gripper action
...
def pick_and_place(env, source_id, target):
    ...
    if stacking:
        ...
        place_pos = np.asarray(target, dtype=float)
